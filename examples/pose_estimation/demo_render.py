...
def main():
    ...
    parser.add_argument('-i', '--filename-input', type=str, 
        default="/home/luo/workspace/thesis_ws/SoftRas/data/YCB/019_pitcher_base/textured_simple.obj")
    ...
    renderer = sr.SoftRenderer(camera_mode='projection', image_size=1028,P=p)
